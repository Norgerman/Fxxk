...
namespace DX
{
    namespace Sharp
    {
        ...
        public:
            ...
            Attribute(Scene3D^ scene, void* data, System::UInt32 elementSize, System::UInt32 size, System::UInt32 stride);
        ...
        {
        public:
            MemoryAttribute(Scene3D^ scene, System::Memory<T> data, System::UInt32 stride);
